...
- 2026-07-04: 完成 paper readiness ledger。新增 `build_module2_paper_readiness.py`, 生成 `0_trials/module2_paper_readiness/module2_paper_readiness.json` 和 `.md`; 当前 `partial_methods_ready_results_blocked`, method/system/no-warm scoped claim 可写, formal results/main table/warm-start effect 继续 blocked。记录见 `.pipeline/experiments/20260704_module2_paper_readiness_ledger.md`。
