...
- missing_counts_by_category: `{'decision': 0, 'decision_gate': 1, 'regeneration': 21, 'gate_sequence': 7, 'training': 3, 'evaluation': 2, 'acceptance': 3, 'evaluation_acceptance': 2, 'claim_gate': 9}`
...
- source_regeneration_target_count: `21`
...
- `preflight_source_fresh_regeneration` (regeneration): status=`blocked`, missing=`21`, runs_training=`False`
  - blocked_by: `source_freshness_regeneration_required, handoff_safety_issues_open, remote_packet_safety_audit_failed, remote_packet_safety_audit_issues_open`
