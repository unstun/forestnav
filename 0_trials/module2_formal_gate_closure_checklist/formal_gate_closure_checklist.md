...
- post_plan_blocked_stage_ids: `['f02_6_decision_record', 'approved_remote_preflight', 'regenerate_remote_execution_packet', 'regenerate_h01_h02_formal_artifacts', 'regenerate_claim_gate_artifacts']`
...
- `approved_remote_preflight_and_packet` (remote_preflight): status=`blocked`, missing=`5`, runs_training=`False`
...
- `gate3_formal_eval_outputs` (evaluation): status=`blocked`, missing=`2`, runs_training=`False`
  - blocked_by: `eval_gate3_eval_episodes_csv, eval_gate3_summary_json, handoff_safety_issues_open, remote_packet_safety_audit_failed, remote_packet_safety_audit_issues_open, missing_remote_pullback_artifact, missing_ppo_result_rows, missing_ppo_checkpoint_hash, source_fresh_preflight_targets_open`
...
- `post_plan_gate3_remote_audit_pullback_allowed_with_blockers`: allowed post-plan stage gate3_remote_audit_pullback must not carry blocked_by.
