...
- missing_counts_by_category: `{'decision': 0, 'decision_gate': 1, 'regeneration': 18, 'gate_sequence': 7, 'training': 3, 'evaluation': 2, 'acceptance': 3, 'evaluation_acceptance': 2, 'claim_gate': 9}`
- formal_ordered_next_step_count: `6`
- post_plan_blocked_stage_ids: `['f02_6_decision_record', 'approved_remote_preflight', 'regenerate_remote_execution_packet', 'gate3_remote_training', 'gate3_remote_audit_pullback', 'regenerate_h01_h02_formal_artifacts', 'regenerate_claim_gate_artifacts']`
- source_regeneration_target_count: `18`
...
- `preflight_source_fresh_regeneration` (regeneration): status=`blocked`, missing=`18`, runs_training=`False`
...
- `gate3_formal_eval_outputs` (evaluation): status=`blocked`, missing=`2`, runs_training=`False`
  - blocked_by: `eval_gate3_eval_episodes_csv, eval_gate3_summary_json, f02_6_warm_start_decision_pending, source_freshness_regeneration_required, handoff_safety_issues_open, handoff_step_blockers_mismatch_run_remote_training, handoff_step_blockers_mismatch_run_remote_audit, remote_packet_safety_audit_failed, remote_packet_safety_audit_issues_open, remote_packet_safety_stale_status, remote_packet_safety_blockers_mismatch_run_remote_training, remote_packet_safety_blockers_mismatch_run_remote_audit, remote_training_packet_not_ready, missing_remote_pullback_artifact, missing_ppo_result_rows, missing_ppo_checkpoint_hash, source_fresh_preflight_targets_open, remote_packet_not_ready`
...
- `gate3_audit_pullback_hashes` (acceptance): status=`blocked`, missing=`3`, runs_training=`False`
  - blocked_by: `gate3_trial_manifest_json, gate3_formal_audit_json, pulled_back_checkpoint_hash_record, f02_6_warm_start_decision_pending, source_freshness_regeneration_required, handoff_safety_issues_open, handoff_step_blockers_mismatch_run_remote_training, handoff_step_blockers_mismatch_run_remote_audit, remote_packet_safety_audit_failed, remote_packet_safety_audit_issues_open, remote_packet_safety_stale_status, remote_packet_safety_blockers_mismatch_run_remote_training, remote_packet_safety_blockers_mismatch_run_remote_audit, remote_training_packet_not_ready, missing_remote_pullback_artifact, missing_ppo_result_rows, missing_ppo_checkpoint_hash, source_fresh_preflight_targets_open, remote_packet_not_ready`
...
- `claim_gate_regeneration` (claim_gate): status=`blocked`, missing=`9`, runs_training=`False`
