...
- `gate3_formal_eval_outputs` (evaluation): status=`blocked`, missing=`2`, runs_training=`False`
  - blocked_by: `eval_gate3_eval_episodes_csv, eval_gate3_summary_json, handoff_safety_issues_open, handoff_step_allowed_mismatch_run_remote_audit, handoff_step_blockers_mismatch_run_remote_audit, remote_packet_safety_audit_failed, remote_packet_safety_audit_issues_open, remote_packet_safety_allowed_mismatch_run_remote_audit, remote_packet_safety_blockers_mismatch_run_remote_audit, missing_remote_pullback_artifact, missing_ppo_result_rows, missing_ppo_checkpoint_hash, remote_training_not_completed`
