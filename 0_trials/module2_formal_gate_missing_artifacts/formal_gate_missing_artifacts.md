...
- `claim_gate_regeneration` (claim_gate): complete=`False`, blocked_by=`formal_gate_missing_artifacts, formal_gate_status_report, paper_readiness, h02_formal_acceptance_before_claim_gate`
