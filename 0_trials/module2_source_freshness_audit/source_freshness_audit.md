...
- current_head: `dc50d331bab77d20217414f3eb93f27effa3e449`
- runs_training: `False`
...
- `claim_safety`: status=`blocked_formal_performance_claims`, freshness=`current_clean`, source_head=`dc50d331bab77d20217414f3eb93f27effa3e449`
- `paper_readiness`: status=`partial_methods_ready_results_blocked`, freshness=`current_dirty`, source_head=`dc50d331bab77d20217414f3eb93f27effa3e449+dirty`
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`current_dirty`, source_head=`dc50d331bab77d20217414f3eb93f27effa3e449+dirty`
- `post_f02_6_plan_audit`: status=`post_f02_6_plan_audit_passed`, freshness=`current_dirty`, source_head=`dc50d331bab77d20217414f3eb93f27effa3e449+dirty`
- `remote_packet_safety_audit`: status=`remote_packet_safety_audit_passed`, freshness=`current_dirty`, source_head=`dc50d331bab77d20217414f3eb93f27effa3e449+dirty`
- `formal_gate_closure_checklist`: status=`formal_gate_closure_blocked`, freshness=`current_dirty`, source_head=`dc50d331bab77d20217414f3eb93f27effa3e449+dirty`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`current_dirty`, source_head=`dc50d331bab77d20217414f3eb93f27effa3e449+dirty`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_dirty`, source_head=`dc50d331bab77d20217414f3eb93f27effa3e449+dirty`
