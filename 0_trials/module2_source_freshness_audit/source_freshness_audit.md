...
- current_head: `e1a6329a97e0baa55aad8212196a537acc4dc302`
- runs_training: `False`
...
- `max_commits_since_source`: `136`
- `max_non_self_changed_path_count_since_source`: `98`
...
- `f02_6_transition_gate_audit`: `historical_clean`, source_head=`b1c238c311ee96e614e4cc48094b712f1c352d7e`, current_head=`e1a6329a97e0baa55aad8212196a537acc4dc302`, dirty=`False`, commit_exists=`True`, commits_since_source=`35`, changed_paths_since_source=`16`, non_self_changed_paths_since_source=`14`, blocking_changed_paths_since_source=`8`, self_artifact_only_lag=`False`, tracked_artifact_only_lag=`False`, blocking_regeneration=`True`, artifact_path_changed=`True`, required before `approved_remote_preflight`, path `0_trials/module2_f02_6_transition_gate_audit/f02_6_transition_gate_audit.json`
...
- `mainline_formal_gate_state_audit`: `historical_clean`, source_head=`2cd4e13da6aff82d096cbf7cd11595f859ec4d05`, current_head=`e1a6329a97e0baa55aad8212196a537acc4dc302`, dirty=`False`, commit_exists=`True`, commits_since_source=`37`, changed_paths_since_source=`19`, non_self_changed_paths_since_source=`17`, blocking_changed_paths_since_source=`9`, self_artifact_only_lag=`False`, tracked_artifact_only_lag=`False`, blocking_regeneration=`True`, artifact_path_changed=`True`, required before `formal_claim_gate`, path `0_trials/module2_mainline_formal_gate_state_audit/mainline_formal_gate_state_audit.json`
...
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`current_clean`, source_head=`e1a6329a97e0baa55aad8212196a537acc4dc302`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`current_clean`, source_head=`e1a6329a97e0baa55aad8212196a537acc4dc302`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_clean`, source_head=`e1a6329a97e0baa55aad8212196a537acc4dc302`
- `formal_gate_remaining_deliverables`: status=`formal_gate_deliverables_blocked`, freshness=`current_clean`, source_head=`e1a6329a97e0baa55aad8212196a537acc4dc302`
...
- `formal_gate_handoff_bundle`: status=`blocked_until_protocol_lane_decision`, freshness=`current_clean`, source_head=`e1a6329a97e0baa55aad8212196a537acc4dc302`
