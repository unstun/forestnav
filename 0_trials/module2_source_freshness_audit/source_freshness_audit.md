...
- current_head: `09c1a5aca8740caca5539f5a2ad98076c6dbc895`
- runs_training: `False`
...
- `claim_safety`: status=`blocked_formal_performance_claims`, freshness=`historical_clean`, source_head=`b66f09b9bcf1c4a7dfeeedd63f04d023fb134807`
- `paper_readiness`: status=`partial_methods_ready_results_blocked`, freshness=`current_clean`, source_head=`09c1a5aca8740caca5539f5a2ad98076c6dbc895`
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`historical_dirty`, source_head=`b66f09b9bcf1c4a7dfeeedd63f04d023fb134807+dirty`
- `post_f02_6_plan_audit`: status=`post_f02_6_plan_audit_passed`, freshness=`historical_dirty`, source_head=`b66f09b9bcf1c4a7dfeeedd63f04d023fb134807+dirty`
...
- `formal_gate_closure_checklist`: status=`formal_gate_closure_blocked`, freshness=`historical_dirty`, source_head=`b66f09b9bcf1c4a7dfeeedd63f04d023fb134807+dirty`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`historical_dirty`, source_head=`b66f09b9bcf1c4a7dfeeedd63f04d023fb134807+dirty`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_dirty`, source_head=`09c1a5aca8740caca5539f5a2ad98076c6dbc895+dirty`
