...
- current_head: `2cd4e13da6aff82d096cbf7cd11595f859ec4d05`
- runs_training: `False`
...
- `f02_6_transition_gate_audit`: status=`f02_6_transition_gate_audit_passed`, freshness=`historical_clean`, source_head=`82cec025c50398dc56df7de4a1ea15b3c5e67287`
...
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_clean`, source_head=`2cd4e13da6aff82d096cbf7cd11595f859ec4d05`
...
- `mainline_formal_gate_state_audit`: status=`mainline_formal_gate_state_consistent_blocked`, freshness=`current_clean`, source_head=`2cd4e13da6aff82d096cbf7cd11595f859ec4d05`
