...
- current_head: `1c4364955a1f03c5120fc05ec1fce353a4b283a8`
- runs_training: `False`
...
- `claim_safety`: status=`blocked_formal_performance_claims`, freshness=`historical_clean`, source_head=`6d37e38edc682bb7a7b924b8cec729e2b4201d93`
- `paper_readiness`: status=`partial_methods_ready_results_blocked`, freshness=`historical_dirty`, source_head=`6d37e38edc682bb7a7b924b8cec729e2b4201d93+dirty`
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`historical_dirty`, source_head=`d85cecce085b77a59b83ea0604feb4bf3fc2939a+dirty`
- `post_f02_6_plan_audit`: status=`post_f02_6_plan_audit_passed`, freshness=`historical_dirty`, source_head=`78c31aff487cc7769d09f400964b17eb7e66c30c+dirty`
- `remote_packet_safety_audit`: status=`remote_packet_safety_audit_passed`, freshness=`historical_dirty`, source_head=`78c31aff487cc7769d09f400964b17eb7e66c30c+dirty`
- `formal_gate_closure_checklist`: status=`formal_gate_closure_blocked`, freshness=`current_clean`, source_head=`1c4364955a1f03c5120fc05ec1fce353a4b283a8`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`historical_dirty`, source_head=`d85cecce085b77a59b83ea0604feb4bf3fc2939a+dirty`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`historical_clean`, source_head=`6d37e38edc682bb7a7b924b8cec729e2b4201d93`
