...
- current_head: `b66f09b9bcf1c4a7dfeeedd63f04d023fb134807`
- runs_training: `False`
...
- `claim_safety`: status=`blocked_formal_performance_claims`, freshness=`current_clean`, source_head=`b66f09b9bcf1c4a7dfeeedd63f04d023fb134807`
- `paper_readiness`: status=`partial_methods_ready_results_blocked`, freshness=`current_dirty`, source_head=`b66f09b9bcf1c4a7dfeeedd63f04d023fb134807+dirty`
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`historical_dirty`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124+dirty`
- `post_f02_6_plan_audit`: status=`post_f02_6_plan_audit_passed`, freshness=`historical_dirty`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124+dirty`
...
- `formal_gate_closure_checklist`: status=`formal_gate_closure_blocked`, freshness=`historical_dirty`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124+dirty`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`historical_dirty`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124+dirty`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_dirty`, source_head=`b66f09b9bcf1c4a7dfeeedd63f04d023fb134807+dirty`
