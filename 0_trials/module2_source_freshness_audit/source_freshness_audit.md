...
- current_head: `73997d6461a81a2b69568ef4c181e01345b6a901`
- runs_training: `False`
...
- `claim_safety`: status=`blocked_formal_performance_claims`, freshness=`current_clean`, source_head=`73997d6461a81a2b69568ef4c181e01345b6a901`
- `paper_readiness`: status=`partial_methods_ready_results_blocked`, freshness=`current_dirty`, source_head=`73997d6461a81a2b69568ef4c181e01345b6a901+dirty`
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`current_dirty`, source_head=`73997d6461a81a2b69568ef4c181e01345b6a901+dirty`
- `post_f02_6_plan_audit`: status=`post_f02_6_plan_audit_passed`, freshness=`current_dirty`, source_head=`73997d6461a81a2b69568ef4c181e01345b6a901+dirty`
...
- `formal_gate_closure_checklist`: status=`formal_gate_closure_blocked`, freshness=`historical_dirty`, source_head=`09c1a5aca8740caca5539f5a2ad98076c6dbc895+dirty`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`historical_dirty`, source_head=`09c1a5aca8740caca5539f5a2ad98076c6dbc895+dirty`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_dirty`, source_head=`73997d6461a81a2b69568ef4c181e01345b6a901+dirty`
