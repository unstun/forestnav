...
- current_head: `414970cfb79086679983d3110e202642abc63f8d`
- runs_training: `False`
...
- `max_commits_since_source`: `108`
- `max_non_self_changed_path_count_since_source`: `92`
...
- `f02_6_decision_gate_audit`: `historical_clean`, source_head=`82cec025c50398dc56df7de4a1ea15b3c5e67287`, current_head=`414970cfb79086679983d3110e202642abc63f8d`, dirty=`False`, commit_exists=`True`, commits_since_source=`108`, changed_paths_since_source=`93`, non_self_changed_paths_since_source=`92`, blocking_changed_paths_since_source=`37`, self_artifact_only_lag=`False`, tracked_artifact_only_lag=`False`, blocking_regeneration=`True`, artifact_path_changed=`True`, required before `approved_remote_preflight`, path `0_trials/module2_f02_6_decision_gate_audit/f02_6_decision_gate_audit.json`
- `f02_6_decision_intake`: `historical_clean`, source_head=`82cec025c50398dc56df7de4a1ea15b3c5e67287`, current_head=`414970cfb79086679983d3110e202642abc63f8d`, dirty=`False`, commit_exists=`True`, commits_since_source=`108`, changed_paths_since_source=`93`, non_self_changed_paths_since_source=`91`, blocking_changed_paths_since_source=`37`, self_artifact_only_lag=`False`, tracked_artifact_only_lag=`False`, blocking_regeneration=`True`, artifact_path_changed=`True`, required before `approved_remote_preflight`, path `0_trials/module2_f02_6_decision_intake/f02_6_decision_intake.json`
...
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`historical_clean`, source_head=`82cec025c50398dc56df7de4a1ea15b3c5e67287`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`historical_clean`, source_head=`82cec025c50398dc56df7de4a1ea15b3c5e67287`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_clean`, source_head=`414970cfb79086679983d3110e202642abc63f8d`
- `formal_gate_remaining_deliverables`: status=`formal_gate_deliverables_blocked`, freshness=`historical_clean`, source_head=`82cec025c50398dc56df7de4a1ea15b3c5e67287`
...
- `formal_gate_handoff_bundle`: status=`blocked_until_protocol_lane_decision`, freshness=`current_clean`, source_head=`414970cfb79086679983d3110e202642abc63f8d`
