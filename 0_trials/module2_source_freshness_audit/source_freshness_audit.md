...
- current_head: `adcef774f4f03a30ff53e59154adcedf2e366124`
- runs_training: `False`
...
- `claim_safety`: status=`blocked_formal_performance_claims`, freshness=`current_clean`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124`
- `paper_readiness`: status=`partial_methods_ready_results_blocked`, freshness=`current_dirty`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124+dirty`
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`current_dirty`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124+dirty`
- `post_f02_6_plan_audit`: status=`post_f02_6_plan_audit_passed`, freshness=`current_dirty`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124+dirty`
- `remote_packet_safety_audit`: status=`remote_packet_safety_audit_passed`, freshness=`historical_dirty`, source_head=`52a18baf31c14b81fcb309bbc33c149501ea6b65+dirty`
- `formal_gate_closure_checklist`: status=`formal_gate_closure_blocked`, freshness=`current_dirty`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124+dirty`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`historical_dirty`, source_head=`3cbf62bc0f572416355c4afdb2a68971dd292ee9+dirty`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_dirty`, source_head=`adcef774f4f03a30ff53e59154adcedf2e366124+dirty`
