...
- current_head: `4729e3e371124e04bb6c88d1a323a511bec0780f`
- runs_training: `False`
...
- `remote_formal_execution_packet`: status=`blocked_until_f02_6_decision`, freshness=`current_dirty`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f+dirty`
...
- `claim_safety`: status=`blocked_formal_performance_claims`, freshness=`current_clean`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f`
- `paper_readiness`: status=`partial_methods_ready_results_blocked`, freshness=`current_dirty`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f+dirty`
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`current_dirty`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f+dirty`
- `post_f02_6_plan_audit`: status=`post_f02_6_plan_audit_passed`, freshness=`current_dirty`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f+dirty`
- `remote_packet_safety_audit`: status=`remote_packet_safety_audit_passed`, freshness=`current_dirty`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f+dirty`
- `formal_gate_closure_checklist`: status=`formal_gate_closure_blocked`, freshness=`current_dirty`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f+dirty`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`current_dirty`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f+dirty`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_dirty`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f+dirty`
