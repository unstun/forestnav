...
- current_head: `ea099a0093efa84f2b535ddec1a5290c3497e07a`
- runs_training: `False`
...
- `formal_gate_closure_checklist`: `current_dirty`, required before `approved_remote_preflight`, path `0_trials/module2_formal_gate_closure_checklist/formal_gate_closure_checklist.json`
- `formal_gate_gap_audit`: `current_dirty`, required before `approved_remote_preflight`, path `0_trials/module2_formal_gate_gap_audit/formal_gate_gap_audit.json`
...
- `remote_formal_execution_packet`: status=`blocked_until_f02_6_decision`, freshness=`historical_dirty`, source_head=`4729e3e371124e04bb6c88d1a323a511bec0780f+dirty`
...
- `claim_safety`: status=`blocked_formal_performance_claims`, freshness=`current_clean`, source_head=`ea099a0093efa84f2b535ddec1a5290c3497e07a`
- `paper_readiness`: status=`partial_methods_ready_results_blocked`, freshness=`current_dirty`, source_head=`ea099a0093efa84f2b535ddec1a5290c3497e07a+dirty`
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`current_dirty`, source_head=`ea099a0093efa84f2b535ddec1a5290c3497e07a+dirty`
- `post_f02_6_plan_audit`: status=`post_f02_6_plan_audit_passed`, freshness=`current_dirty`, source_head=`ea099a0093efa84f2b535ddec1a5290c3497e07a+dirty`
- `remote_packet_safety_audit`: status=`remote_packet_safety_audit_passed`, freshness=`current_dirty`, source_head=`ea099a0093efa84f2b535ddec1a5290c3497e07a+dirty`
- `formal_gate_closure_checklist`: status=`formal_gate_closure_blocked`, freshness=`current_dirty`, source_head=`ea099a0093efa84f2b535ddec1a5290c3497e07a+dirty`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`current_dirty`, source_head=`ea099a0093efa84f2b535ddec1a5290c3497e07a+dirty`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_dirty`, source_head=`ea099a0093efa84f2b535ddec1a5290c3497e07a+dirty`
