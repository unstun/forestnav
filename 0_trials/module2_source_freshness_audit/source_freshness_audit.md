...
- current_head: `6448a955286c0d56b8d8744c9885fa12f6f71120`
- runs_training: `False`
...
- `claim_safety`: status=`blocked_formal_performance_claims`, freshness=`historical_clean`, source_head=`073c271fb77714de6c498cd5114704d239faf8f8`
- `paper_readiness`: status=`partial_methods_ready_results_blocked`, freshness=`historical_dirty`, source_head=`073c271fb77714de6c498cd5114704d239faf8f8+dirty`
- `formal_gate_gap_audit`: status=`blocked_formal_gate_gaps_open`, freshness=`current_dirty`, source_head=`6448a955286c0d56b8d8744c9885fa12f6f71120+dirty`
- `post_f02_6_plan_audit`: status=`post_f02_6_plan_audit_passed`, freshness=`current_dirty`, source_head=`6448a955286c0d56b8d8744c9885fa12f6f71120+dirty`
- `remote_packet_safety_audit`: status=`remote_packet_safety_audit_passed`, freshness=`current_dirty`, source_head=`6448a955286c0d56b8d8744c9885fa12f6f71120+dirty`
- `formal_gate_closure_checklist`: status=`formal_gate_closure_blocked`, freshness=`current_dirty`, source_head=`6448a955286c0d56b8d8744c9885fa12f6f71120+dirty`
...
- `formal_gate_missing_artifacts`: status=`formal_gate_missing_artifacts_open`, freshness=`current_dirty`, source_head=`6448a955286c0d56b8d8744c9885fa12f6f71120+dirty`
- `formal_gate_status_report`: status=`formal_gate_status_blocked`, freshness=`current_dirty`, source_head=`6448a955286c0d56b8d8744c9885fa12f6f71120+dirty`
- `formal_gate_handoff_bundle`: status=`blocked_until_f02_6_decision`, freshness=`current_clean`, source_head=`6448a955286c0d56b8d8744c9885fa12f6f71120`
