...
- `h02_formal_scope_and_scale_match_h01` (formal_scope): status=`blocked_formal_acceptance`, paper_result_input_allowed_now=`False`
  - missing_artifact_ids: `h02_verdict_formal_acceptance_true, h01_manifest_ready, h01_blocker_missing_module2_rl_rs_checkpoint, h01_blocker_realmap_query_generation_not_frozen, remote_execution_packet_ready, remote_packet_blocker_f02_6_warm_start_decision_pending, remote_packet_blocker_missing_module2_bc_checkpoint, remote_packet_blocker_missing_module2_rl_rs_checkpoint, remote_packet_blocker_realmap_query_generation_not_frozen, remote_packet_blocker_remote_formal_preflight_not_ready, remote_packet_blocker_warm_start_decision_pending, h02_scale_satisfies_h01`
