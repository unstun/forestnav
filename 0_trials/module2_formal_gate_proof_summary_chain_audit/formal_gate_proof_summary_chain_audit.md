...
- proof_open: `True`
- row_count: `14`
- consistent_row_count: `6`
- missing_row_count: `0`
- mismatch_row_count: `8`
- next_action_guard_row_count: `3`
- next_action_guard_consistent_row_count: `1`
- next_required_deliverables_row_count: `3`
- next_required_deliverables_consistent_row_count: `1`
...
- `claim_safety_status_report_next_action_guard_summary_mismatch`: Downstream next-action guard summary does not match the status-report baseline.
- `paper_readiness_claim_safety_next_action_guard_summary_mismatch`: Downstream next-action guard summary does not match the status-report baseline.
- `claim_safety_status_report_next_required_formal_deliverables_summary_mismatch`: Downstream next-required formal deliverables summary does not match the status-report baseline.
- `paper_readiness_claim_safety_next_required_formal_deliverables_summary_mismatch`: Downstream next-required formal deliverables summary does not match the status-report baseline.
...
- `claim_safety_status_report_next_action_guard`: present=`True`, matches=`False`, expected_next_action_id=`None`, execution_leak_count=`2`, path=`0_trials/module2_claim_safety/module2_claim_safety.json`, key=`status_report_next_action_guard_summary`
- `paper_readiness_claim_safety_next_action_guard`: present=`True`, matches=`False`, expected_next_action_id=`None`, execution_leak_count=`2`, path=`0_trials/module2_paper_readiness/module2_paper_readiness.json`, key=`claim_safety_next_action_guard_summary`
...
- `claim_safety_status_report_next_required_formal_deliverables`: present=`True`, matches=`False`, total_missing_deliverables=`10`, row_count=`10`, runs_training=`False`, path=`0_trials/module2_claim_safety/module2_claim_safety.json`, key=`status_report_next_required_formal_deliverables`
- `paper_readiness_claim_safety_next_required_formal_deliverables`: present=`True`, matches=`False`, total_missing_deliverables=`10`, row_count=`10`, runs_training=`False`, path=`0_trials/module2_paper_readiness/module2_paper_readiness.json`, key=`claim_safety_next_required_formal_deliverables`
