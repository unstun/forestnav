...
- `claim_safety_handoff_single_next_action_index_source_freshness_blocks`: Single-next-action handoff must not hide a blocking source-freshness regeneration requirement.
