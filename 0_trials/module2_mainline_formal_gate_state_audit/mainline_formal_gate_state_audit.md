...
- `mainline_missing_expected_next_action`: Mainline task book must mention the current expected next action.
...
- `protocol_lane_status_contract_drafting_not_open`: Recorded protocol-lane state should open only contract drafting.
