...
- `v2_contract_promoted`: satisfied=`False`, observed=`draft`, expected=`['approved', 'frozen']`
- `v2_contract_readiness_ready`: satisfied=`False`, observed=`v2_contract_readiness_blocked`, expected=`v2_contract_ready_for_source_freshness`
...
- `v2_remote_packet_ready`: satisfied=`False`, observed=`{'status': 'blocked_until_v2_contract_promotion', 'remote_preflight_allowed_now': False}`, expected=`{'status': 'ready_for_v2_remote_preflight', 'remote_preflight_allowed_now': True}`
