...
def test_remaining_deliverables_catches_unsafe_or_incomplete_inputs(tmp_path):
    ...
    assert "unlock_chain_evaluation_eval_gate3_eval_episodes_csv_missing_current_blockers" not in issue_ids
    assert "unlock_chain_training_train_summary_json_missing_current_blockers" not in issue_ids
    assert (
